...
func _ready():
	var enemy_1_res = preload("res://game/level_1/resources/enemy_1.tres")
	var enemy_2_res = preload("res://game/level_1/resources/enemy_2.tres")
	var enemy_3_res = preload("res://game/level_1/resources/enemy_3.tres")
